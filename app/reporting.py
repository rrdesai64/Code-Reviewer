...
def markdown_report(scan: ScanResult) -> str:
    ...
    lines = [
        ...
        f'- Exploitability context: {format_counts(scan.summary.exploitability_counts)}',
        f'- Changed-file findings: {scan.summary.changed_file_findings}',
        f'- Request-handler findings: {scan.summary.request_handler_findings}',
