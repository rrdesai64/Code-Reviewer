...
def scan_arguments(manifest: dict[str, Any]) -> str:
    args = [
        ...
        '-UnifiedSoundnessOut', str(GUEST_REPORT_WORK / 'unified-soundness-verdict.json'),
        ...
        '-DastOut', str(GUEST_REPORT_WORK / 'dast-verification.json'),
