...
- Open scan-level reports from the IDE:
  ...
  - remediation plan, Jira/Linear issue plan, Slack/Teams chat agent, messaging gateway, team learning dashboard, memory context, advanced AI report, AI finding review, and compliance report
